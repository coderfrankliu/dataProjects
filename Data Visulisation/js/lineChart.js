// constructor - make a new visulization object
...
LineChart.prototype.wrangleData = function(){
    ...
    vis.yVariable = $("#info-select").val()

    // Filter data based on selections
    vis.sliderValues = $("#date-slider1").slider("values")
    vis.dataFiltered = filteredData[vis.country].filter(function(d) {
        return ((d.year >= vis.sliderValues[0]) && (d.year <= vis.sliderValues[1]))
    })
...
LineChart.prototype.updateVis = function(){
    ...
    // adjust for y-axis format valus
    ...
    function mousemove() {
        ...
        focus.attr("transform", "translate(" + vis.x(d.year) + "," + vis.y(d[vis.yVariable]) + ")");
    ...
    // Update y-axis label
    var newLabel = (vis.yVariable == "income") ? "Income" :
        ((vis.yVariable == "population") ? "Population" :
            "Life Expectancy")
